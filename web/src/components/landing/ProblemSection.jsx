...
export default function ProblemSection() {
  const problems = [
    ...
    },
    {
      ...
      desc: '97,74 juta orang Indonesia masih unbanked/underbanked (OJK 2024), termasuk jutaan petani kecil. OJK merespons dengan menerbitkan regulasi Alternative Credit Scoring (POJK No. 29/2024).',
      stat: '97,74 juta',
